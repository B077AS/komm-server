...
public class UserPingRequestHandler implements ClientInboundMessageHandler {
    ...
    public WsMessageType getType() {
        return WsMessageType.USER_PING_REQUEST;
    }
    ...
    public void handle(WebSocketSession session, JsonObject payload) {
        ...
        log.debug("USER_PING_REQUEST: observer={} target={} server={}", observerId, targetUserId, serverId);
        pingProbeService.subscribe(serverId, observerId, targetUserId);
    }
}
