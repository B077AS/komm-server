...
public class StreamUnwatchHandler implements ClientInboundMessageHandler {
    ...
    public WsMessageType getType() {
        return WsMessageType.STREAM_UNWATCH;
    }
    ...
    public void handle(WebSocketSession session, JsonObject payload) {
        ...
        int count = webrtcRoomsManager.removeWatcher(streamerUserId, watcherUserId);
